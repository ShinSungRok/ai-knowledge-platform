...
**Task 7 — Search knowledge document use case.**
`SearchKnowledgeDocumentsUseCase` filters by title/text through the repository
port. Validate with:
...
| `pnpm validate:application` | List + Create + Update + Delete + Search knowledge document use cases |
