...
**Task 6 — Delete knowledge document use case.**
`DeleteKnowledgeDocumentUseCase` removes documents through the repository
port. Validate with:
...
| `pnpm validate:application` | List + Create + Update + Delete knowledge document use cases |
